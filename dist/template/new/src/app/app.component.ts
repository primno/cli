import { MnComponent, PageType, MnOnFormLoad, MnOnColumnChange, FormEventArg } from "@primno/core";
...
export class AppComponent {
    ...
    /**
     * onNameChange is an event handler that will be called when the name column is changed due to the @MnOnColumnChange decorator.
     * Show the notification "Name changed to <name>".
    */
    @MnOnColumnChange("name")
