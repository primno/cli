...
Primno is a Front-end framework for Model-Driven Apps (PowerApps / Dynamics 365) that helps to build and deploy JS customizations faster.
...
2. Set the unique name of the solution where the web-resources will be added in the primno.json file.
...
2. Add the web-resource to an account form and only register the "form on load" event to `mn_app.onFormLoad` function. Others form events will be automatically registered by Primno.
